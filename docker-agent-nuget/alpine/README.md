# New Relic .NET Agent Sample - Docker (Alpine) - NuGet

## Overview

This sample demonstrates running a .NET 10 Web API in an Alpine-based Docker container with New Relic .NET Agent instrumentation via NuGet packages.
