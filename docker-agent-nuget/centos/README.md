# New Relic .NET Agent Sample - Docker (Centos) - NuGet

## Overview

This sample demonstrates running a .NET 7 Web API in a Centos-based Docker container, with New Relic .NET Agent instrumentation via NuGet packages.
