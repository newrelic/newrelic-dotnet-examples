...
This sample demonstrates how to install and configure the New Relic .NET agent for deployment to [AWS Elastic Beanstalk](https://aws.amazon.com/elasticbeanstalk/) (.NET 10 / x64 / Amazon Linux 2023).
