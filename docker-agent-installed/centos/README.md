...
This sample demonstrates running a .NET 10 Web API in a Centos-based Docker container, with New Relic .NET Agent instrumentation. The sample application is just the "default" application created 
